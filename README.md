...
- Start by going to this repo in github
     vselect settings > pages > (build and development) > deploy from branch > gh-pages > /(root)
...
After you edit or majke any documentation changes you want to clean, and rebuild your docs
